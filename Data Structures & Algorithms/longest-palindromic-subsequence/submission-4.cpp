...
public:
    int longestPalindromeSubseq(string s) {
        ...
        for(int i=0; i<s.size(); i++) {
            // The answer for a substring s[L...R] is independent of whether we reached it from an odd-length or even-length palindrome. Therefore, the same cache can be shared by both types of calls.
